#!/usr/bin/env python3
"""
Smoke Test for PaddleOCR-VL Skill
...
4. Select "VL" model and copy the API URL
...
Or manually create .env file in project root:
  PADDLEOCR_VL_API_URL=https://your-api-url.paddleocr.com/vl
  PADDLEOCR_VL_ACCESS_TOKEN=your_token_here
...
def main():
    ...
    print("=" * 60)
    print("\nNext steps:")
    print('  python skills/paddleocr-vl/scripts/vl_caller.py --file-url "URL"')
    print('  python skills/paddleocr-vl/scripts/vl_caller.py --file-path "doc.pdf"')
