...
def main():
    parser = argparse.ArgumentParser(description="PP-OCRv5 smoke test")
    parser.add_argument(
        "--test-url",
        help="Optional: Custom image URL for testing"
    )
    parser.add_argument(
        "--skip-api-test",
        action="store_true",
    ...
    test_url = args.test_url or "https://raw.githubusercontent.com/PaddlePaddle/PaddleOCR/release/2.7/doc/imgs/11.jpg"
    ...
    print("=" * 60)
    print("\nNext steps:")
    print('  python skills/pp-ocrv5/scripts/ocr_caller.py --file-url "URL" --pretty')
    print('  python skills/pp-ocrv5/scripts/ocr_caller.py --file-path "image.png" --pretty')
